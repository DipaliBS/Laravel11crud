                                        ...
                                        <tr id="row<?php echo e($product->id); ?>">
                                            ...
                                            <td>
                                                <?php if(!empty($product->image)): ?>
                                                    <img class="product-image" width="50" src="<?php echo e(asset('/uploads/products/'.$product->image)); ?>" alt="Product Image">
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="btn btn-sm btn-dark">Edit</a>
                                                <button class="btn btn-sm btn-danger deleteProduct" data-id="<?php echo e($product->id); ?>">Delete</button>
                                            </td>
                                        </tr>
